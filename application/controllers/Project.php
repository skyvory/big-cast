...
class Project extends CI_Controller {
				...
				<div class="media" style="background-color: #ddd; margin: 10px 20px; padding: 10px;">
					...
					<div class="media-body" style="margin: 15px;">
						...
						<div class="project-action pull-right">
							...
							<a href="#" class="btn btn-default disabled">Play</a>
						</div>
					</div>
				</div>
			<?php
	...
	public function resource($project_id = FALSE) {
		...
		if($proj) {
			$sess_array = array('id' => $proj['project_id'], 'title' => $proj['title'], 'description' => $proj['description'], 'user' => $proj['fk_user_id'], 'status' => $proj['fk_projectstatus_id']);
