...
$(document.body).on('mouseover', '.line-delete-button, .sprite-delete-button', function() {
	$(this).tooltip({
		title: "remove line"
	});
	$(this).tooltip('show');
...
$(document.body).on('mouseover', '.line-collapse-button', function() {
	$(this).tooltip({
...
$(document.body).on('mouseover', 'input[name=jumpto]', function() {
	$(this).tooltip({
...
$(document.body).on('mouseover', 'input[name=choice_jumpto]', function() {
	$(this).tooltip({
